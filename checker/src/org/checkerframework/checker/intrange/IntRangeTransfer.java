package org.checkerframework.checker.intrange;

import java.util.List;
import javax.lang.model.element.AnnotationMirror;
import org.checkerframework.checker.intrange.IntRangeAnnotatedTypeFactory;
import org.checkerframework.checker.intrange.qual.IntRange;
import org.checkerframework.checker.intrange.utils.Range;
...
public class IntRangeTransfer extends CFTransfer {
    ...
    public IntRangeTransfer(CFAbstractAnalysis<CFValue, CFStore, CFTransfer> analysis) {
        super(analysis);
    ...
    private AnnotationMirror createIntRangeAnnotation(Range range) {
        return ((IntRangeAnnotatedTypeFactory) atypefactory).createIntRangeAnnotation(range);
    }

    private TransferResult<CFValue, CFStore> createNewResult(
            TransferResult<CFValue, CFStore> result, Range resultRange) {
        if (resultRange == null) {
            return result;
        }
    ...
    private Range calculateNumericalBinaryOp(
        ...
        if (!isCoveredKind(leftNode) || !isCoveredKind(rightNode)) {
            return null;
        }
    ...
    private Range calculateNumericalUnaryOp(
    ...
    public TransferResult<CFValue, CFStore> visitNumericalPlus(
        ...
        Range resultRange = calculateNumericalUnaryOp(n.getOperand(), NumericalUnaryOps.PLUS, p);
        return createNewResult(transferResult, resultRange);
    }
    ...
    public TransferResult<CFValue, CFStore> visitNumericalMinus(
        ...
        Range resultRange = calculateNumericalUnaryOp(n.getOperand(), NumericalUnaryOps.MINUS, p);
        return createNewResult(transferResult, resultRange);
    }
    ...
    /**
     * For expression leftN &lt; rightN or leftN &ge; rightN:
    ...
    public TransferResult<CFValue, CFStore> visitLessThan(
        ...
        return strengthenAnnotationOfComparison(
                res, leftN, rightN, leftV, rightV, ComparisonOperators.LESS_THAN);
    }
    ...
    public TransferResult<CFValue, CFStore> visitLessThanOrEqual(
        ...
        return strengthenAnnotationOfComparison(
                res, leftN, rightN, leftV, rightV, ComparisonOperators.LESS_THAN_EQ);
    }
    ...
    public TransferResult<CFValue, CFStore> visitGreaterThan(
        ...
        return strengthenAnnotationOfComparison(
                res, leftN, rightN, leftV, rightV, ComparisonOperators.GREATER_THAN);
    }
    ...
    public TransferResult<CFValue, CFStore> visitGreaterThanOrEqual(
        ...
        return strengthenAnnotationOfComparison(
                res, leftN, rightN, leftV, rightV, ComparisonOperators.GREATER_THAN_EQ);
    }
    ...
    public TransferResult<CFValue, CFStore> visitEqualTo(
        ...
        return strengthenAnnotationOfComparison(
                res, leftN, rightN, leftV, rightV, ComparisonOperators.EQUAL);
    }
    ...
    public TransferResult<CFValue, CFStore> visitNotEqual(
        ...
        return strengthenAnnotationOfComparison(
                res, leftN, rightN, leftV, rightV, ComparisonOperators.NOT_EQUAL);
    }
}
