...
public final class UnitsAnnotatedTypeFormatter extends DefaultAnnotatedTypeFormatter {
    ...
    public UnitsAnnotatedTypeFormatter(BaseTypeChecker checker) {
        // Create a DefaultAnnotatedTypeFormatter with our formatter instead of the default
        // formatter
        super(
    ...
    protected static class UnitsAnnotationFormatter extends DefaultAnnotationFormatter {
        ...
        /**
         * Loops through a given a set of annotation mirrors and removes Prefix.one if it is found
         * in any annotation. This method creates a new set with the modified annotation mirrors in
         * it, then passes the set to super for further processing.
         */
        @Override
