...
% Reference to Checker Framework Javadoc for a package.
% Arg 1: directory under org/checkerframework/, including internal "/", but
% no leading or trailing "/".
% Arg 2: fully qualified package name.
% In the printed version, only the package name appears.
% In the HTML version, it's a link to the Javadoc.
\newcommand{\refpackage}[2]{\href{../api/org/checkerframework/#1/package-summary.html}{\<#2>}}
...
% Now, for Java EE:
\newcommand{\javaeejavadoc}[2]{\href{http://docs.oracle.com/javaee/7/api/#1}{\<#2>}}
\newcommand{\javaeejavadocanno}[2]{\href{http://docs.oracle.com/javaee/7/api/#1}{\<@#2>}}
